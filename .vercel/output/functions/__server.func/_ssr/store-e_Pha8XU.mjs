//#region node_modules/.nitro/vite/services/ssr/assets/config-CHd09tmy.js
...
var KNOWN_EVENT_SET = /* @__PURE__ */ new Set([
	"page_view",
	"session_start",
	"first_visit",
	"user_engagement",
...
var FUNNEL_STEPS = [
	{
		id: "visitor",
		label: "Visitors",
		events: ["session_start", "page_view"]
	},
	{
		id: "product",
		label: "Product views",
	...
	{
		id: "spec",
		label: "LED / spec views",
		events: ["led_product_view"]
	},
	{
		id: "quote_start",
		label: "Quote started",
		events: ["quotation_start", "form_start"]
	},
	{
		id: "quote_submit",
		label: "Quote submitted",
		events: ["quotation_submit"]
	},
	{
		id: "lead",
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/store-e_Pha8XU.js
...
//#endregion
export { loadRecentEvents as a, sanitizeParams as c, COLLECT_ENDPOINT as d, EVENT_VALUE_AED as f, KEY_EVENTS as h, loadEventsSince as i, CHANNELS as l, GA4_MEASUREMENT_ID as m, insertLiveEvent as n, normalizeIncoming as o, FUNNEL_STEPS as p, isKnownEvent as r, sanitizeEventName as s, countByOrigin as t, CITIES as u };

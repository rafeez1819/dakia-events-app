...
import { n as insertLiveEvent, o as normalizeIncoming } from "./store-e_Pha8XU.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { a as union, i as string, n as number, r as object, t as literal } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DPyr0A4-.js
var router_DPyr0A4__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DjvoyDMr.css";
...
var $$splitComponentImporter$3 = () => import("./routes-ClLWwl5I.mjs");
var SCHEMA = {
...
var Route$1 = createFileRoute("/api/collect")({ server: { handlers: { POST: async ({ request }) => {
	if (limited(clientIp(request))) return Response.json({
		ok: false,
	...
	try {
		...
		if (text.length > MAX_BODY) return Response.json({
			ok: false,
			message: "Payload too large"
		}, { status: 413 });
	...
	if (body.consent !== "granted") return Response.json({
		ok: true,
		skipped: true
	});
...
//#endregion
export { getRouter, router_DPyr0A4__exports as t };

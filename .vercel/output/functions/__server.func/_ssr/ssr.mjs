...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DUWtH_m2.mjs");
...
var manifest = {
	"6965dde659a9df9761e56f679ed55ad254108c59bed38275fa2b9720d6fd9031": {
		functionName: "getIntelSnapshot_createServerFn_handler",
		importer: () => import("./queries-BI8WEpAj.mjs")
	},
	"9fcfb67a1ddb797c5252384dcd5259962da8b397c956eca5b01d9ac764e0f760": {
		functionName: "generateDailyIntelligence_createServerFn_handler",
		importer: () => import("./ai-Ui1ovmQv.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D2DCSelA.mjs").then((n) => n.t),

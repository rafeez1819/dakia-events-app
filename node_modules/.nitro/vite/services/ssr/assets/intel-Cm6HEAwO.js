...
import { n as summarizeForAi } from "./engine-CfoH9ADi.js";
import { r as loadConsent } from "./consent-DuG9pQXb.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Activity, ArrowLeft, Brain, Funnel, Globe2, Radio, Shield, Sparkles, Table2, Workflow } from "lucide-react";
...
//#endregion
//#region src/lib/analytics/ai.ts
...
//#endregion
//#region src/lib/analytics/queries.ts
...
//#endregion
//#region src/components/intel/IntelApp.tsx
var NAV = [
	{
		id: "overview",
		label: "Overview",
...
function IntelApp() {
	...
	if (!snap) return /* @__PURE__ */ jsx("div", {
		...
		children: [/* @__PURE__ */ jsxs("aside", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "size-4" }), /* @__PURE__ */ jsx("span", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("main", {
					...
					children: [
						view === "overview" && /* @__PURE__ */ jsx(Overview, { snap }),
						view === "acquisition" && /* @__PURE__ */ jsx(Acquisition, { snap }),
						view === "funnel" && /* @__PURE__ */ jsx(FunnelView, { snap }),
						view === "leads" && /* @__PURE__ */ jsx(LeadsView, { snap }),
						view === "realtime" && /* @__PURE__ */ jsx(RealtimeView, { snap }),
						view === "debugger" && /* @__PURE__ */ jsx(DebuggerView, { snap }),
						view === "ai" && /* @__PURE__ */ jsx(AiView, { snap }),
						view === "architecture" && /* @__PURE__ */ jsx(Architecture, {}),
						view === "privacy" && /* @__PURE__ */ jsx(PrivacyView, {})
					]
				})
			]
		})]
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [typeof delta === "number" && /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						className: "space-y-3",
						children: snap.topPages.map((p) => /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						className: "mb-4 font-cond text-[11px] tracking-[0.22em] text-gold uppercase",
						children: "Anomalies"
					}), snap.anomalies.length === 0 ? /* @__PURE__ */ jsx("p", {
						className: "text-sm text-mute",
						children: "No z-score flags above 2.4 in this window."
					}) : /* @__PURE__ */ jsx("ul", {
						className: "space-y-3",
						children: snap.anomalies.slice(0, 6).map((a) => /* @__PURE__ */ jsxs("li", {
		...
		children: [
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: snap.deviceMix.map((d) => {
							...
							return /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: d.name }), /* @__PURE__ */ jsxs("span", {
									className: "tabular-nums text-mute",
									children: [
										n(d.users),
										" · ",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: snap.geoMix.map((g) => /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("p", {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsx("tbody", { children: snap.leadsList.slice(0, 40).map((l) => /* @__PURE__ */ jsxs("tr", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: Object.entries(byCity).map(([city, count]) => /* @__PURE__ */ jsxs("div", {
						className: "flex justify-between border border-line px-3 py-2 text-sm",
						children: [/* @__PURE__ */ jsx("span", { children: city }), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: snap.realtime.slice(0, 12).map((v) => /* @__PURE__ */ jsxs("li", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("p", {
			...
			children: /* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsx("tbody", { children: snap.liveEvents.slice(0, 50).map((e, i) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t border-line",
					children: [
						/* @__PURE__ */ jsx("td", {
...
function PrivacyView() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("p", { children: "Consent Mode v2 starts denied. Advertising storage stays denied even when analytics is granted — this desk is lead intelligence, not ads personalization. First-party collection is off until you accept." }),
			/* @__PURE__ */ jsxs("div", {
				className: "border border-line bg-elev p-5",
				children: [/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("p", { children: "Forbidden in GA4 payloads: email, phone, name, address, free-text enquiry bodies. The contact API accepts those fields to fulfil the enquiry and does not forward them to measurement." }),
			/* @__PURE__ */ jsx(Link, {
				to: "/privacy",
...
//#endregion
//#region src/routes/intel.tsx?tsr-split=component
function IntelPage() {
	return /* @__PURE__ */ jsx(IntelApp, {});
}
//#endregion

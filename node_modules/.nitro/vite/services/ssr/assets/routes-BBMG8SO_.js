import { i as EVENT_VALUE_AED, o as GA4_MEASUREMENT_ID, r as COLLECT_ENDPOINT, s as KEY_EVENTS } from "./config-CHd09tmy.js";
import { c as sanitizeParams, o as isKnownEvent, s as sanitizeEventName } from "./store-e_Pha8XU.js";
import { i as saveConsent, n as hasAnalyticsConsent, r as loadConsent, t as applyGtagConsent } from "./consent-DuG9pQXb.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Activity } from "lucide-react";
//#region src/lib/analytics/ids.ts
...
//#endregion
//#region src/lib/analytics/tracker.ts
var booted = false;
var tracking = false;
...
//#endregion
//#region src/components/analytics/ConsentBanner.tsx
function granted() {
	return {
...
//#endregion
//#region src/components/analytics/IntelDock.tsx
function IntelDock() {
...
//#endregion
//#region src/components/analytics/AnalyticsRoot.tsx
function AnalyticsRoot({ children, dock = true }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		dock ? /* @__PURE__ */ jsx(IntelDock, {}) : null
	] });
}
//#endregion
//#region src/components/site/dakia-body.html?raw
...
//#endregion
//#region src/components/site/runtime.ts
...
//#endregion
//#region src/components/site/DakiaSite.tsx
function DakiaSite() {
...
function Home() {
	return /* @__PURE__ */ jsx(AnalyticsRoot, { children: /* @__PURE__ */ jsx(DakiaSite, {}) });
}
//#endregion
